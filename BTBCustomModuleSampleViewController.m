...
- (void)viewDidLoad {
	...
	// if you want to change the background or create more than one module in one row, you can add [self.containerView setHidden:YES] then create a background container by yourself
